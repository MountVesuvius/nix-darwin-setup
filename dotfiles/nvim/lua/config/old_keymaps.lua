-- I haven't decided what I want to do with this setup
-- so i'm leaving it in a different file and "forgetting about it"
...
local function laptop_navigation()
  ...
  -- fixes the jumplist issue
  map("n", "<C-h>", "<C-i>", { noremap = true })
